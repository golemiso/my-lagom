package com.golemiso.mylagom.api
...
object MylagomService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The my-lagom service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the MylagomService.
  */
trait MylagomService extends Service {
  ...
  override final def descriptor = {
    ...
    named("my-lagom")
      ...
      .withTopics(
        topic(MylagomService.TOPIC_NAME, greetingsTopic)
